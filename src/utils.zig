...
pub fn columnOpt(iter: [*c]const flecs.c.EcsIter, comptime T: type, index: i32) ?[*]T {
...
pub fn columnNonQuery(iter: [*c]const flecs.c.EcsIter, comptime T: type, index: i32) ?[*]T {
    if (index <= 0) return null;
